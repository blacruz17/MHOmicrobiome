...
saveRDS(fit, "./svmRadialWeights_upsampl.rds")
...
saveRDS(fit, "./svmRadialWeights_downsampl.rds")
...
saveRDS(fit, "./svmRadialWeights_smote.rds")
...
saveRDS(fit, "./svmRadialWeights_rose.rds")
